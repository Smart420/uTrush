...
render() {
    return (
      ...
      //               <Text style={{fontWeight: 'bold', fontSize: 24 ,alignSelf:'center', color:'#1565C0',marginBottom:10,}}>General waste</Text>
      //                   <View style={{flex:1,flexDirection: 'column',marginLeft:10,marginRight:10,backgroundColor:'rgba(0,0,0,0)'}}>
      //                       <Text style={{fontWeight: 'bold', fontSize: 18 ,marginLeft:5,color:'#424242',}}>General waste Type</Text>
      //                       <Text style={{fontSize: 13 ,color:'#757575'}}>General waste , material must be free of any actual or apparent contamination (pathological/infectious, radioactive and/ or hazardous chemical). In some cases, after disinfection or decontamination, previously contaminated material may be treated as general waste.</Text>
      //                       <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Examples of general waste include: Office waste (paper, boxes, folders, plastic, glass), decontaminated labware (see Medical Waste section), animal bedding (not contaminated), etc.</Text>
      //                       <Text style={{fontWeight: 'bold', fontSize: 18 ,marginLeft:5,color:'#424242',}}>Let see the common ways of managing waste</Text>
      //                             <Image style={{width:"90%",height:200,/*opacity:0.2,*/alignSelf:'center',}}
      //                                          source={require('../img/Ge1.png')}
      //                                         />
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>1. Incineration method of waste management:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>This simply means burning waste. This method is common in countries with limited landfill space. Incineration chambers can be small for domestic use, but there are large ones for municipal use as well. It is great for treating waste with contamination (like those from hospitals) and hazardous waste from factories, but the method produces too much carbon dioxide. Modern incineration processes are more efficient and release less dioxin than home fireplaces and backyard barbecues. This method is very common in Denmark, Germany and the Netherlands. This method is effective, but expensive.</Text>
      //                             <Image style={{width:"90%",height:200,/*opacity:0.2,*/alignSelf:'center',}}
      //                                          source={require('../img/Ge2.png')}
      //                                         />
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>2. Sanitary Landfills as waste disposal:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Generally, this term means a large piece of land away from living places where all the waste from a town is deposited. But there is more to landfills. Proper landfill management involves sorting out all the waste (waste separation), and sending only the waste that cannot be recycled and composted to the site. </Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Proper landfills, are also lined at the bottom to minimize the leakage of soil pollutants and other toxins from getting into the water table. This method is effective, but expensive and difficult.</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>In many towns, sorting is not done, and all the waste (paper, food, diapers, glass) is mixed up and deposited. That is a problem because, glass, and plastics take thousands of years to decompose. Additionally, the landfills soon become full, smelly and unsafe for the environment.</Text>
...
render() {
    return (
        ...
        <View style={styles._teamPage}>
            ...
            <View style={{flex:1,flexDirection: 'column'}}> 
                    <ScrollView contentContainerStyle={{paddingVertical: 20}}>
                    <Text style={{fontWeight: 'bold', fontSize: 24 ,alignSelf:'center', color:'#2e7d32',marginBottom:10,}}>Organic waste</Text>
                    
                         <View style={{flex:1,marginLeft:10,marginRight:10,backgroundColor:'rgba(0,0,0,0)'}}> 
                            <Text style={{fontWeight: 'bold', fontSize: 18 ,marginLeft:5,color:'#424242',}}>Organic type</Text>
                            <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Organic waste comes from plants or animals sources. Commonly, they include food waste, fruit and vegetable peels, flower trimmings and even dog poop can be classified as organic waste. They are biodegradable (this means they are easily broken down by other organisms over time and turned into manure).</Text>
                            <Text style={{fontWeight: 'bold', fontSize: 18 ,marginLeft:5,color:'#424242',}}>The medthod for disposal organic waste</Text>
                                <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Composting</Text>
                                    <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>With the right conditions (air and moisture), organic waste such as food and plant materials can be decomposed by bacteria, fungi, worms and organisms. Decayed organic matter is humus. Yard waste such as grass and flower clippings can also be composted.</Text>
                                    <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Composting comes in two kinds: bin/pile composting and worm composting (vermiculture).</Text>
                                    <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Bin/pile composting is easier for many households because one does not have to be too careful with what to put into it. Here is what you need:</Text>
                                      <Image style={{width:"90%",height:200,/*opacity:0.2,*/alignSelf:'center',}}
                                               source={require('../img/Or1.png')}
                                              />            
                                              
                                    <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',marginLeft:20,}}>1. Get an old bin or box (1 cubic yard), or you can buy one from the shop. Ensure that you punch holes around it to help with aeration. </Text> 
                                    <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',marginLeft:20,}}>2. Prepare your organic waste matter. Make sure you cut them into pieces (about 1inch in size). Do not throw in big chunks of the waste. Make sure you separate the organic waste into brown and green parts. Brown parts include waste like wood chips, saw-dust, yard waste shreds, straw and hay, dry leaves and shredded paper. Green parts include grass trimmings, fruit and veggie scraps, green leaves and livestock manure.</Text>
                                    <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',marginLeft:20,}}>3. Put the waste in the box in layers, 50% green, 50% brown.</Text>
                                    <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',marginLeft:20,}}>4. Mix and add some water every 7 days. </Text>
                                    <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>In a couple of weeks, the compost will be ready. It will look dark-brown and smell just like soil.</Text>
...
render() {
    return (
      ...
      //       <View style={{flex:1,flexDirection: 'column'}}>
      //               <ScrollView contentContainerStyle={{paddingVertical: 20}}>
      //               <Text style={{fontWeight: 'bold', fontSize: 24 ,alignSelf:'center', color:'#f9a825',marginBottom:10,}}>Recycle waste</Text>
                    
      //                   <View style={{flex:1,flexDirection: 'column',marginLeft:10,marginRight:10,backgroundColor:'rgba(0,0,0,0)'}}>
      //                       <Text style={{fontWeight: 'bold', fontSize: 18 ,marginLeft:5,color:'#424242',}}>Recycle type</Text>
      //                       <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Recycling is processing used materials (waste) into new, useful products. This is done to reduce the use of raw materials that would have been used. Waste that can be potentially recycled is termed "Recyclable waste". Aluminum products (like soda, milk and tomato cans), Plastics (grocery shopping bags, plastic bottles), Glass products (like wine and beer bottles, broken glass), Paper products (used envelopes, newspapers and magazines, cardboard boxes) can be recycled and fall into this category.</Text>
      //                       <Image style={{width:"90%",height:200,/*opacity:0.2,*/alignSelf:'center',}}
      //                                          source={require('../img/Re1.png')}
      //                                         />   
      //                       <Text style={{fontWeight: 'bold', fontSize: 18 ,marginLeft:5,color:'#424242',}}>Here is how paper waste is recycled:</Text>
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Collection, transportation and storage:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>The biggest task for paper recycling companies is probably the collection, transporting and sorting of waste paper. </Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>This is because we always add paper to other waste items and get them contaminated with food, plastics and metals. </Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Sometimes collected paper is sent back to the landfills because they are too contaminated for use. Try to keep waste paper in separate grades at home or in the office —example, do not mix newspapers and corrugated boxes up.</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>All paper recovered is sent to the recycling center, where it is packed, graded, put into bales and sent to the paper mill. At the mill, all the paper is stored in a warehouse until it is needed.</Text>
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Preparation:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>At the collection center, a huge magnet is rolled over them as they move on the conveyor belt to pull out all the metal and steel cans. Only the aluminum cans are washed, crushed, condensed into 30-pounds briquettes for other companies for further processing. The rest is also sorted and sent to their appropriate recycling centers.</Text>
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Melting:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>The crushed cans are loaded into a burning furnace, where all printing and designs on the cans are removed, melted and blended with new (virgin) aluminum. The molten (liquid) aluminum is poured into moulds and made into bars called ingots.</Text>
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Sheets:</Text>
                                    
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>The ingots are then fed into powerful rollers, which flatten them into thin sheets of aluminum of about 25.4 in thickness. These thin sheets are rolled into coils and sold or sent to can-making factories. They use the aluminum coils to prepare cans and containers for other food and drink manufacturers. It is estimated that cans collected at collection points take up to 60 days to be appear in the shops again as new cans containing your favourite soda, juice or food.</Text>
      //                               <Image style={{width:"90%",height:200,/*opacity:0.2,*/alignSelf:'center',}}
      //                                          source={require('../img/Re2.png')}
      //                                         /> 
      //                       <Text style={{fontWeight: 'bold', fontSize: 18 ,marginLeft:5,color:'#424242',}}>Aluminum recycling</Text>
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Collection:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Local councils provide special can recycling containers (bins) that are clearly marked. This helps people to know what to place in them. Cans include soda, fruit and vegetable cans. Trucks come for these at pick up spots to the recycling centers. Cans may also be metallic or steel, but people do not know the difference.</Text>
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Preparation:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>At the collection center, a huge magnet is rolled over them as they move on the conveyor belt to pull out all the metal and steel cans. Only the aluminum cans are washed, crushed, condensed into 30-pounds briquettes for other companies for further processing. The rest is also sorted and sent to their appropriate recycling centers.</Text>
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Melting:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>The crushed cans are loaded into a burning furnace, where all printing and designs on the cans are removed, melted and blended with new (virgin) aluminum. The molten (liquid) aluminum is poured into moulds and made into bars called ingots.</Text>
      ...
      //                                         /> 
      //                       <Text style={{fontWeight: 'bold', fontSize: 18 ,marginLeft:5,color:'#424242',}}>How is glass recycled?</Text>
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Collection:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>Many cities have collection spots. Trucks may also pick them up from your home, or you may be required to drop them off at a point in your town. In all cases, try to do what the authorities have suggested. So, be sure you know the various glass types that are collected from your home. Always wash and separate them into the required grades for collection.</Text>
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Cleaning and Crushing:</Text>
      ...
      //                           <Text style={{fontWeight: 'bold', fontSize: 14 ,paddingTop: 5,color:'#424242',}}>Ready for use:</Text>
      //                               <Text style={{fontSize: 13 ,paddingBottom:10,color:'#757575',}}>The cullet is then transported to glass-making factories. Here, it is mixed with sand, soda ash and limestone. It is heated at very high temperature and melted into liquid glass. This liquid is then poured into moulds that give glass its shape.</Text>
